...
export const enUS = {
  ...
  // Task 1.5.4 — LLM configuration management
  llm: {
    providersTab: 'Model Providers',
    modelsTab: 'Model Configurations',
    provider: 'Provider',
    model: 'Model',
    ...
    setCategoryDefault: 'Set Category Default',
    ...
    byProviderType: 'By Provider Type',
  ...
  // Task 13.1 — Image Generation Tool (i18n)
  imageGeneration: {
    ...
    form: {
      ...
      inpaintPrompt: 'Inpaint Description',
      uploadEditPrompt: 'Additional Description (optional)',
      size: 'Size',
      count: 'Count',
      countItem: '{n} images',
      countUnit: 'images',
      ...
      polishing: 'Polishing...',
      strength: 'Strength',
      strengthMin: 'Keep Original',
      strengthMax: 'Heavy Edit',
      referenceImage: 'Reference Image',
      sourceImage: 'Source Image',
      editImage: 'Image to Edit',
      maskImage: 'Mask Image',
      uploadHint: 'Click or drag to upload (max 10MB)',
      uploadHintMask: 'Click or drag to upload mask',
      uploadFormat: 'PNG / JPG / WEBP, max 10MB',
      uploadFormatMask: 'Black & white, white = edit area',
      uploadMaskHint: 'White areas will be edited, black areas will be kept',
      editType: 'Edit Type',
      editTypeUpscale: 'Upscale',
      editTypeDenoise: 'Denoise',
      editTypeRelight: 'Relight',
      editTypeStyleTransfer: 'Style Transfer',
      editTypeBackgroundRemove: 'Remove Background',
      placeholder: {
        text2img: 'Describe the image you want to generate...',
        img2img: 'Describe the edits you want...',
        inpaint: 'Describe what to generate in the masked area...',
        uploadEdit: 'Additional description for the edit...',
        size: 'Enter size',
      },
      generate: 'Generate',
    ...
    result: {
      ...
      noResult: 'Generation result will appear here',
      generating: 'Generating...',
      promptLabel: 'Prompt: ',
      imageAlt: 'Result {index}',
    ...
    history: {
      ...
      createdAt: 'Created At',
      page: 'Page {current} / {total}',
      total: 'Total {count} records, page {current} / {total}',
      prevPage: 'Previous',
      nextPage: 'Next',
      delete: 'Delete',
    },
    quota: {
      ...
      validityExpired: 'Quota validity expired',
      notFound: 'No quota assigned',
    },
    errors: {
      network: 'Network error, please retry',
      quotaExceeded: 'Quota exceeded',
      difyError: 'Dify call failed',
      serviceDegraded: 'Service degraded, please try later',
    ...
    admin: {
      ...
      revokeQuota: 'Revoke Quota',
      resetCounters: 'Reset Counters',
      testConnection: 'Test Connection',
      connectionSuccess: 'Connection test passed',
      connectionFailed: 'Connection test failed',
      connectionResultSuccess: 'Connected: {message}',
      connectionResultFailed: 'Failed: {message}',
      manualReset: 'Manual Reset',
      manualResetConfirm: 'Manually reset the degraded state?',
      triggerCleanup: 'Trigger Cleanup',
      triggerCleanupConfirm: 'Manually trigger cleanup?',
      cleanupComplete: 'Cleanup complete: {count} records',
      save: 'Save',
      saving: 'Saving...',
      saveConfig: 'Save Config',
      saveSuccess: 'Config saved',
      saveDegradationSuccess: 'Degradation config saved',
      saveRetentionSuccess: 'Retention config saved',
      saveFailed: 'Save failed',
      cancel: 'Cancel',
      confirm: 'Confirm',
      submitting: 'Submitting...',
      granted: 'Quota revoked',
      revokeConfirm: 'Revoke quota for user {userId}? This cannot be undone.',
      revokeFailed: 'Revoke failed',
      counterReset: 'Counters reset',
      resetConfirm: 'Reset counters for user {userId}?',
      resetFailed: 'Reset failed',
      promptUserId: 'Enter user ID:',
      enterUserId: 'Search by user ID',
      search: 'Search',
      userId: 'User ID',
      ...
      dailyLimitRange: 'Range: 0 ~ 10000',
      monthlyLimitRange: 'Range: 0 ~ 300000',
      validity: 'Validity',
      status: 'Status',
      valid: 'Valid',
      invalid: 'Invalid',
      ...
      actions: 'Actions',
      edit: 'Edit',
      notesPlaceholder: 'Optional, max 200 characters',
      ...
      apiKeyUnset: '(Not set)',
      text2imgWorkflowId: 'Text2Img Workflow ID',
      img2imgWorkflowId: 'Img2Img Workflow ID',
      inpaintWorkflowId: 'Inpaint Workflow ID',
      uploadEditWorkflowId: 'Upload Edit Workflow ID',
      timeoutSeconds: 'Timeout (seconds)',
      timeoutRange: 'Range: 5 ~ 300 seconds',
      apiUrlPlaceholder: 'https://api.dify.ai/v1',
      apiKeyPlaceholder: 'app-xxxxxxxxxxxxxxxx',
      loadConfigLoading: 'Loading config...',
      loadConfigFailed: 'Failed to load config',
      testFailed: 'Test failed',
      testing: 'Testing...',
      loadDegradationLoading: 'Loading degradation status...',
      loadDegradationFailed: 'Failed to load degradation status',
      currentDegradationStatus: 'Current Degradation Status',
      degradationStatus: 'Status',
      degraded: 'Degraded',
      normal: 'Normal',
      failureCount: 'Failure Count',
      degradedAt: 'Degraded At',
      resetting: 'Resetting...',
      resetDegradedSuccess: 'Degraded state cleared',
      resetFailedText: 'Reset failed',
      degradationConfig: 'Degradation Config',
      enableAutoDegradation: 'Enable Auto-Degradation',
      failureThreshold: 'Failure Threshold',
      failureThresholdRange: 'Range: 1 ~ 100',
      degradeDuration: 'Degrade Duration (seconds)',
      degradeDurationRange: 'Range: 10 ~ 86400 seconds (10s ~ 1 day)',
      loadRetentionLoading: 'Loading retention config...',
      loadRetentionFailed: 'Failed to load retention config',
      ossUsage: 'OSS Usage',
      totalFiles: 'Total Files',
      totalSize: 'Total Size',
      retentionConfig: 'Retention Config',
      cleanupMode: 'Cleanup Mode',
      cleanupModeKeepForever: 'Keep Forever',
      cleanupModeDeleteAfterDays: 'Delete after N days',
      cleanupModeDeleteIfUnused: 'Delete if unused for N days',
      retentionDays: 'Retention Days',
      retentionDaysRange: 'Range: 1 ~ 3650 days',
      cleanupCron: 'Cleanup Cron',
      cleanupCronExample: 'e.g. 0 2 * * * means 2 AM daily',
