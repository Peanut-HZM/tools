          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative">
              <input
                ...
                className="w-80 px-5 py-3 pl-12 bg-slate-700/50 border border-slate-600 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20"
              />
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="mb-6 flex items-center justify-between">
              <p className="text-slate-400">
                找到 <span className="text-cyan-400 font-semibold">{total}</span> 门课程
              </p>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-slate-400 text-lg">暂无课程</p>
                <button
                  onClick={handleReset}
            ...
            {!loading && courses.length > 0 && (
              <div className="mt-8 flex items-center justify-center space-x-2">
                <button
                  ...
                  disabled={page === 1}
                  className="px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-slate-400 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-700 hover:text-white transition-colors"
                >
