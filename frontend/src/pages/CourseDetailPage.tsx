  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10 pb-12">
        ...
        {/* Tab 导航 */}
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-700/50 overflow-hidden mb-6">
            ...
            <div className="flex items-center space-x-2 mb-3">
              {[1, 2, 3, 4, 5].map((star) => (
                <button
                  ...
                  className={`text-2xl ${star <= newReview.rating ? 'text-yellow-400' : 'text-slate-600'}`}
                >
                      ...
                      <div className="ml-3">
                        ...
                        <div className="flex items-center">
                          {[...Array(5)].map((_, i) => (
                            <i
                              key={i}
                              className={`fas fa-star ${i < review.rating ? 'text-yellow-400' : 'text-slate-600'}`}
                            ></i>
                          ))}
                        </div>
                      </div>
