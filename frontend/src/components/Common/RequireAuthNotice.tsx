  ...
  return (
    <div className="flex h-full min-h-[300px] items-center justify-center p-6">
      <div className="text-center">
        ...
        <p className="mb-1 text-lg text-ink">该功能需要登录后使用</p>
        <p className="mb-4 text-sm text-ink-faint">登录成功后数据将自动加载</p>
        <button
          onClick={openLoginModal}
          className="rounded-lg bg-accent px-6 py-2 text-ink-inverse transition-colors hover:bg-accent-hover cursor-pointer"
        >
          登录
        </button>
      </div>
