...
const MissingInfoPanel: React.FC<MissingInfoPanelProps> = ({
  ...
  return (
    <div className="border border-warning/30 rounded-lg overflow-hidden">
      {/* Header */}
      <div
        className="flex items-center justify-between p-4 bg-warning/10 cursor-pointer"
      ...
      >
        ...
        <svg
          className={`w-5 h-5 text-warning transform transition-transform ${
      ...
      {!isCollapsed && (
        <div className="p-4 bg-surface-1">
          ...
          {/* Help Text */}
          <div className="mt-4 p-3 bg-accent-info/10 rounded-lg">
