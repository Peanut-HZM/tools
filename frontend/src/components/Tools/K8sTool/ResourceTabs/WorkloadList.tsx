            ...
            >
              ...
              <td className="px-3 py-2">
                <div className="flex items-center gap-1.5">
                  <i className={`${getKindIcon(wl.kind)} text-blue-400 text-xs`}></i>
                  <span className="text-slate-300 text-xs">{wl.kind}</span>
                </div>
              </td>

              {/* 名称 + 命名空间 */}
              <td className="px-3 py-2">
                <div className="text-slate-200 font-medium truncate max-w-[240px]">{wl.name}</div>
                <div className="text-xs text-slate-500 truncate">{wl.namespace}</div>
              </td>
              ...
              {/* 镜像 */}
              <td className="px-3 py-2 text-slate-400 text-xs truncate max-w-[200px]">
