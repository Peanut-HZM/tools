          ...
          <div className="flex justify-between pt-5 border-t border-border">
             {editConfigId ? (
               <button
                 ...
                 disabled={loading}
                 className="bg-danger/10 text-danger border border-danger/50 px-4 py-2 rounded-md text-sm font-medium hover:bg-danger/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-danger transition-colors"
               >
                 {t.common.delete}
               </button>
             ) : <div></div>}
