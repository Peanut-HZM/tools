# 第 6 章：三大 Spec 驱动工具对比 - OpenSpec vs Spec-Kit vs Superpowers

## 学习目标

学完本章后，你将能够：

1. 理解 OpenSpec、Spec-Kit、Superpowers 三个工具的核心差异
2. 在 Cursor 中正确安装和配置这三个工具
3. 根据项目需求选择合适的 Spec 驱动工具
4. 掌握每个工具的核心命令和工作流
5. 了解各工具的文件结构和实现逻辑
