...
class Settings(BaseSettings):
    ...
    CACHE_REDIS_TOKEN_USAGE_TTL: int = 300  # 5 分钟

    # Token Usage 后台定时同步
    TOKEN_USAGE_BACKGROUND_SYNC_ENABLED: bool = True
    TOKEN_USAGE_BACKGROUND_SYNC_INTERVAL_SECONDS: int = 300
